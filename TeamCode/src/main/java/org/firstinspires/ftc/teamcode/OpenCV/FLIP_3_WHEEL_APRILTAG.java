...
import org.firstinspires.ftc.teamcode.Auto.SleeveDetection;
...
public class FLIP_3_WHEEL_APRILTAG extends LinearOpMode {
    ...
    static final double THIRD_LEVEL_INCHES = 27;// HEIGHT FOR THIRD LEVEL IN INCHES
    static final double DOWN_LEVEL_INCHES = 18;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-35, -65.4, Math.toRadians(270));
        ...
        if (tagOfInterest == null || tagOfInterest.id == right) {
            trajSeq = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .splineTo(
                            new Vector2d(-32, -11), Math.toRadians(45),
                    ...
                    //Grab
                    //
                    .splineTo(new Vector2d(-45, -13.5), Math.toRadians(180))
                    ...
                    .lineToLinearHeading(new Pose2d(-50, -13.5, Math.toRadians(180)))
                    ...
                    .splineTo(new Vector2d(-32.5, -11), Math.toRadians(45))
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                        LIFT.setTargetPosition(DOWN);
                        LIFT2.setTargetPosition(DOWN);
                        LIFT.setPower(ARM_SPEED);
                    ...
                    .splineTo(
                            new Vector2d(-33, -10.5), Math.toRadians(45),
                            SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                    )
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                    ...
                    .waitSeconds(0.3) .splineTo(new Vector2d(-45, -13.5), Math.toRadians(180))
                    .lineToLinearHeading(new Pose2d(-59.5, -13.5, Math.toRadians(180)))
