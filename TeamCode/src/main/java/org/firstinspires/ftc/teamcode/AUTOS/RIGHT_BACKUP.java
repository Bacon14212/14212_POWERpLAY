...
public class RIGHT_BACKUP extends LinearOpMode {
    ...
    static final double THIRD_LEVEL_INCHES = 12;// HEIGHT FOR THIRD LEVEL IN INCHES
    static final double DOWN_LEVEL_INCHES = 8;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(35, -64.4, Math.toRadians(270));
        ...
        if (tagOfInterest == null || tagOfInterest.id == right) {
            trajSeq = drive.trajectorySequenceBuilder(startPose)
                     ...
                     * Prelaaded Cone
                     */
                    .lineToSplineHeading(new Pose2d(35, 5, Math.toRadians(0)))
                    ...
                    .lineToSplineHeading(new Pose2d(31, -17, Math.toRadians(45)))
                    ...
                    .lineToLinearHeading(new Pose2d(45, -14, Math.toRadians(0)))
                    .UNSTABLE_addTemporalMarkerOffset(-0.4, () -> {
                        pivotL.setPosition(PIVOT_UP_L);
                        pivotR.setPosition(PIVOT_UP);
                        LIFT.setTargetPosition(LIFT_LEVEL_THREE);
                    ...
                    .splineTo(new Vector2d(31, -18), Math.toRadians(225))
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                        pivotL.setPosition(0.2);
                        pivotR.setPosition(0.8);
                        LIFT.setTargetPosition(DOWN);
        ...
        if (tagOfInterest.id == left) {
            trajSeq3 = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToSplineHeading(new Pose2d(10, -20, Math.toRadians(90)))
                    .waitSeconds(10)
                    .build();
        }
