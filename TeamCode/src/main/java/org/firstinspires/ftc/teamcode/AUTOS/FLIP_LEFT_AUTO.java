    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (tagOfInterest == null || tagOfInterest.id == right) {
            trajSeq = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .splineTo(
                            new Vector2d(-31, -9.7), Math.toRadians(45),
                    ...
                    .lineToLinearHeading(new Pose2d(-59.3, -13, Math.toRadians(180)))
                    ...
                    .splineTo(new Vector2d(-30, -7.5), Math.toRadians(45))
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                        pivotL.setPosition(0.2);
                        pivotR.setPosition(0.8);
                        LIFT.setTargetPosition(DOWN);
                    ...
                    .splineTo(
                            new Vector2d(-30, -7.5), Math.toRadians(45),
                            SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                    )
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                    ...
                    .waitSeconds(0.3) .splineTo(new Vector2d(-45, -13), Math.toRadians(180))
                    .lineToLinearHeading(new Pose2d(-59.3, -13, Math.toRadians(180)))
                    ...
                    .lineToLinearHeading(new Pose2d(-59.3, -14, Math.toRadians(180)))
                    ...
                    .splineTo(
                            new Vector2d(-30, -8), Math.toRadians(45),
                            SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                    )
                    .UNSTABLE_addTemporalMarkerOffset(0.1, () -> {
                    ...
                    .waitSeconds(0.3)
                    .lineToSplineHeading(new Pose2d(-10, -14, Math.toRadians(270)))
                    .waitSeconds(10)
                    .build();
        }
