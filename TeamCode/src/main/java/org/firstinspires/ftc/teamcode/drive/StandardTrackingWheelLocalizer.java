...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 2.28346457; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 14.07; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -4; // in; offset of the lateral wheel

    public static double X_MULTIPLIER =0.12536355; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.074; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        middleEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightFront"));
