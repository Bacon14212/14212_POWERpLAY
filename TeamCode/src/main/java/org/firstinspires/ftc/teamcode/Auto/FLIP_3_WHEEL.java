...
@Disabled
@Autonomous
public class FLIP_3_WHEEL extends LinearOpMode {
    ...
    static final double THIRD_LEVEL_INCHES = 26.5;// HEIGHT FOR THIRD LEVEL IN INCHES
    static final double DOWN_LEVEL_INCHES = 19;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-34.7, -65.3, Math.toRadians(270));
